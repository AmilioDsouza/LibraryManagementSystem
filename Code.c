...
#define FILE_NAME  "LibManSys.bin"
...
void welcomeMessage()
{
    headMessage("-a mini project by Ashutosh and Amilio");
...
void searchBooks()
{
    ...
    if(found)
    {
        ...
        printf("\t\t\tBook issue date(dd/mm/yyyy) =  (%d/%d/%d)",addBookInfoInDataBase.bookIssueDate.dd,
...
void viewBooks()
{
    ...
    while (fread (&addBookInfoInDataBase, sizeof(addBookInfoInDataBase), 1, fp))
    {
        ...
        printf("\t\t\tBook authorName = %s",addBookInfoInDataBase.authorName);
        printf("\t\t\tBook issue date(dd/mm/yyyy) =  (%d/%d/%d)\n\n",addBookInfoInDataBase.bookIssueDate.dd,
               addBookInfoInDataBase.bookIssueDate.mm, addBookInfoInDataBase.bookIssueDate.yyyy);
        found = 1;
        ++countBook;
    }
...
void init()
{
    ...
    const char defaultPassword[] ="Test@123\n";
    sFileHeader fileHeaderInfo = {0};
